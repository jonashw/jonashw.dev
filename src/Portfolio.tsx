  ...
  return (
		<div className="container">
			<div className="mb-5">
				...
				<p>I've had the privilege to work on the following software applications.</p>
			</div>

			<PortfolioApplicationModal system={activeSystem} setSystem={setActiveSystem} />
				...
				{portfolioSystems.map((s, i) => (
					<div key={i}>
						<div className="card h-100" onClick={() => {
							...
							{(s.Screenshots || [{ url: "https://bulma.io/images/placeholders/1280x960.png" }]).slice(0, 1).map((ss,i) => (
								<img src={ss.url} alt={"Screenshot of " + s.Title} className="card-img-top" key={i}/>
							))}
